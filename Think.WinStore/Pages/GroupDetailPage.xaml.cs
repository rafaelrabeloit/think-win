...
namespace Think.WinStore
{
    ...
    /// within the group.
    /// </summary>
    public sealed partial class GroupDetailPage : Think.WinStore.Common.LayoutAwarePage
    {
        ...
        protected override void LoadState(Object navigationParameter, Dictionary<String, Object> pageState)
        {
            ...
            var group = ThinkDataSource.GetGroup((String)navigationParameter);
            if (group == null)
            {
        ...
        void ItemView_ItemClick(object sender, ItemClickEventArgs e)
        {
            ...
            string itemId = ((QuoteItem)e.ClickedItem).UniqueId;
